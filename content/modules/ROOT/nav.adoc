...
** xref:02-03-big-private-vs-open-source-llms.adoc[2.3 Big Private LLMs vs Open Source Domain Specific LLMs]
** xref:02-04-what-is-agentic-ai.adoc[2.4 What is Agentic AI?]
** xref:02-05-why-should-care-agents.adoc[2.5 Why is it important to my organization?]

* 3. AI Agent Frameworks
** xref:03-01-langgraph.adoc[3.1 LangGraph]
** xref:03-02-autogen-framework.adoc[3.2 AutoGen Framework]
** xref:03-03-crew-ai.adoc[3.3 CrewAI]
** xref:03-04-llama-index.adoc[3.4 LlamaIndex]
...
** xref:06-02-supervision-pm.adoc[6.2 Supervision & PM Implementation (PM)]
