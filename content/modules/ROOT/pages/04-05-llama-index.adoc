...
* link:https://github.com/rh-aiservices-bu/agentic-workshop/blob/main/lab-materials/07-agent-frameworks/7.1-tool-calling-autogen-granite3-system.ipynb[LlamaIndex Example]
